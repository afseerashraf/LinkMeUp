...
function updateDateTime() {
  ...
  var currentDateTime = new Date().toLocaleDateString('en-US', options);

  datetimeElement.textContent = currentDateTime;
}

// Call the function to update the date and time immediately and then at one-second intervals
updateDateTime();
